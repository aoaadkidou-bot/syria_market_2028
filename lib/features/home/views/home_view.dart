...
class _HomeViewState extends State<HomeView> {
  ...
  void _setupTimers() {
    ...
    _newsTimer = Timer.periodic(
        Duration(seconds: _systemConfig.tickerSpeedSeconds), (timer) {
    ...
    _bannerTimer = Timer.periodic(
        Duration(seconds: _systemConfig.bannerSwitchIntervalSeconds), (timer) {
      if (mounted) {
  ...
  Future<void> _loadInitialDataFromSupabase() async {
    ...
    try {
      ...
      if (newsRes != null && (newsRes as List).isNotEmpty) {
        setState(() {
          _newsTickerList =
              (newsRes).map((e) => e['content'].toString()).toList();
        });
      }

      // 3. جلب الإعلانات من جدول ads
      final adsRes = await _supabase
          .from('ads')
          .select()
      ...
      if (adsRes != null) {
        setState(() {
          _adsList =
              (adsRes as List).map((map) => AdModel.fromMap(map)).toList();
        });
      }
    } catch (e) {
    ...
    setState(() {
      _adsList = [
        AdModel(
          ...
          description:
              'سيارة كيا فورتي كاملة المواصفات، فتحة سقف، بصمة تشغيل، جنوط كروم، فحص كامل كرت أبيض جاهزة للفراغ الفوري.',
          priceUsd: 14500,
          priceSyp: 217500000,
        ...
        AdModel(
          ...
          description:
              'شقة فاخرة طابق رابع مع مصعد وتدفئة مستقلة، 3 غرف نوم وصالون كبير ومطبخ أمريكي مجهز بالكامل.',
          priceUsd: 85000,
          priceSyp: 1275000000,
        ...
        AdModel(
          ...
          description:
              'الجهاز بحالة الوكالة 100% نسبة البطارية، مجمرك نظامي مع كامل ملحقاته وعلبته الأصلية.',
          priceUsd: 1150,
          priceSyp: 17250000,
      ...
      child: Scaffold(
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                    color: syriaGoldAccent, shape: BoxShape.circle),
                child: const Icon(Icons.storefront,
                    color: syriaGreenPrimary, size: 20),
              ),
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon:
                        const Icon(Icons.search, color: syriaGreenPrimary),
                    filled: true,
              ...
              if (_isLoadingAds)
                const Padding(
                  ...
                  child: Center(
                      child:
                          CircularProgressIndicator(color: syriaGreenPrimary)),
                )
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        const Text(
                            'لا توجد إعلانات مطابقة لخيارات الفلترة الحالية',
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.grey)),
                        const SizedBox(height: 6),
                        const Text('جرب اختيار محافظة أخرى أو قسم رئيسي آخر.',
                ...
                ...filteredAds
                    .map((ad) => _buildAdCard(
                        context, ad, syriaGreenPrimary, syriaGoldAccent))
                    .toList(),
            ],
          ),
        ),
        ...
        bottomNavigationBar: BottomNavigationBar(
                  ...
                  builder: (ctx) => AddAdView(
                    onAdPublished: (newAd) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text(
                                '✨ تم نشر إعلانك بنجاح في سوق سوريا الشامل 2028!')),
                      );
                    },
                  ),
                ),
          ...
          items: [
            ...
            const BottomNavigationBarItem(
                icon: Icon(Icons.chat), label: 'الرسائل'),
            BottomNavigationBarItem(
              icon: Container(
                padding: const EdgeInsets.all(6),
                decoration: const BoxDecoration(
                    color: syriaGreenPrimary, shape: BoxShape.circle),
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: gold, borderRadius: BorderRadius.circular(6)),
            child: Row(
              children: [
          ...
          Expanded(
            child: AnimatedSwitcher(
              ...
              child: Text(
                _newsTickerList.isNotEmpty
                    ? _newsTickerList[_currentNewsIndex]
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                          colors: [Color(0xFF0F5132), Color(0xFF1E293B)]),
                    ),
                ...
                itemBuilder: (ctx, index) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
                      gradient: const LinearGradient(
                          colors: [Color(0xFF1E293B), Color(0xFF0F5132)]),
                    ),
                    padding: const EdgeInsets.all(10),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildCategoriesBar(Color green, Color gold) {
    final subcategories =
        _selectedCategory != null && _categoriesMap[_selectedCategory] != null
            ...
            child: ListView(
              ...
              children: subcategories.map((sub) {
                final isSelected = (_selectedSubcategory == sub) ||
                    (_selectedSubcategory == null && sub == 'الكل');
                return Padding(
                  padding: const EdgeInsets.only(left: 6),
                  child: ChoiceChip(
                    label: Text(sub,
                ...
                Container(
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (ctx, _, __) => Container(
                      ...
                      child: const Center(
                        child:
                            Icon(Icons.image, size: 50, color: Colors.white38),
                      ),
                    ),
                  ),
                ),
        ...
        children: [
              ...
              children: [
                ...
                const Text('سوق سوريا الشامل 2028',
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.bold,
                        fontSize: 16)),
                const Text('منصة البيع والشراء الأولى في سوريا',
          ...
          ListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('صفحة باقات VIP الذهبية')));
            },
          ),
          ListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text('دخول غرفة العمليات (Super Admin)')));
            },
          ),
          const Divider(),
          ListTile(
